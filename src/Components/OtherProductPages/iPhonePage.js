  ...
  render() { 
    return (
      ...
      {/* <div className='thisone' > */}
        <ParallaxLayer offset={1} speed={3} className='therewasprocontainerwhite' style={{ backgroundColor: 'rgba(0,0,0,1)' }}>

        </ParallaxLayer>
        <ParallaxLayer offset={1} speed={-3} className='therewasprocontainer' style={{ backgroundColor: 'rgba(0,0,0,1)', backgroundImage: 'https://www.apple.com/v/iphone-11-pro/c/images/overview/camera/camera_three_lens_system_phone__cokiuc6tixw2_large.jpg', backgroundSize: 'cover', height: '50', color: 'white'}}>
